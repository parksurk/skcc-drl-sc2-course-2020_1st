...
from s10071.skdrl.pytorch.model.mlp import NaiveMultiLayerPerceptron
from s10071.skdrl.pytorch.model.cnn import CNNFC
from s10071.skdrl.common.memory.memory import ExperienceReplayMemory
from s10071.skdrl.pytorch.model.dqn import DQN, prepare_training_inputs
...
class TerranRLAgentWithRawActsAndRawObs(TerranAgentWithRawActsAndRawObs):
    def __init__(self):
        ...
        self.data_file_qnet = 's10071_rlagent_with_vanilla_dqn_qnet'
        self.data_file_qnet_target = 's10071_rlagent_with_vanilla_dqn_qnet_target'
